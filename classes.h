...
std::string    toText      (Any a);
std::string    toTextMax   (Any a);

void      setup       ();
std::string    toTextInt   (int n);
std::string    toTextIntR  (int* n);
Cons*     mylist        ();
Cons*     mylist        (Any i0);
...
std::string    toTextTypeInfo(TypeInfo* ti);
std::string    toTextAny   (Any a);
